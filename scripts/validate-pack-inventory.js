...
const inventory=JSON.parse(await readFile("assets/gameplay/0.0.5/inventory.v1.json","utf8"));
const assetFiles=[...inventory.payload.map(({path})=>`assets/gameplay/0.0.5/${path}`),"assets/gameplay/0.0.5/inventory.v1.json","assets/gameplay/0.0.5/proof.v1.json"];
const packageFiles=[
