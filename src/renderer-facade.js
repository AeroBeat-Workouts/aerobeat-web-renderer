...
const DEBUG_POSITION_BOUNDS=Object.freeze({x:40,yMin:-8,yMax:32,zMin:-32,zMax:72});
...
export class AeroPlayCanvasRenderer {
  ...
  resetDebugCamera(){this.debugYaw=Math.PI;this.debugPitch=-0.13;this.debugPosition={x:0,y:3.15,z:-7.8};this.debugLastFrameTimeMs=null;this.applyDebugPose();return this.describe();}
