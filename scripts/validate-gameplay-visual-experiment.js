...
assert.deepEqual(rendererVisualScaleBounds,{min:.1,max:2});
{
  ...
  assert.deepEqual({...normalizeRendererTuning({...defaultRendererTuning,hash:undefined}),hash:"visual-playcanvas-v5"},defaultRendererTuning,"default tuning round-trips through the v5 normalization exactly");
