...
assert.deepEqual(rendererVisualScaleBounds,{min:.1,max:2});
{
  ...
  assert.deepEqual({...normalizeRendererTuning({...defaultRendererTuning,hash:undefined}),hash:"visual-playcanvas-v4"},defaultRendererTuning,"default tuning round-trips through the v4 normalization exactly");
