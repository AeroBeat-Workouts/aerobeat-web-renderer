...
export class AeroPlayCanvasRenderer {
  constructor(options={}){
    ...
    this.onContextLost=(event)=>{event.preventDefault();this.contextLost=true;this.state="context_lost";this.atlasRestorePending=Boolean(this.iconAtlasData);this.iconTexture?.destroy();this.iconTexture=null;this.gameplayAssetLoader.handleContextLost();};
    this.onContextRestored=()=>{if(this.destroyed||!this.app)return;this.contextLost=false;this.contextRestoreCount+=1;this.state="ready";this.gameplayAssetLoadPromise=this.gameplayAssetLoader.preload(this.app);};
  }
  attach(canvas,options=this.contextAttributes){
    ...
    try{
      ...
      this.gameplayAssetLoadPromise=this.gameplayAssetLoader.preload(this.app);
  ...
  detach(){
    ...
    this.gameplayAssetLoader.dispose();this.gameplayAssetLoadPromise=null;
